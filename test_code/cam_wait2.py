...
camera_url = "rtspsrc location=rtsp://admin:Dd22864549*@192.168.1.61:554 latency=0 ! application/x-rtp, media=video ! rtph264depay ! h264parse ! omxh264dec ! nvvidconv ! video/x-raw, format=BGRx, width=1280, height=720 ! appsink drop=1"
    ...
    try:
        ...
        if ret:
            ...
            if lpp != "unknown":
                ...
                # storage.child(f"License_{crop_count}.png").put(f"{frame_out_name}{crop_count}.png")
