...
# camera_url = "gst-launch-1.0 rtspsrc location=rtsp://admin:Dd22864549*@192.168.1.61:554 latency=0 ! application/x-rtp, media=video ! rtph264depay ! h264parse ! omxh264dec ! nvvidconv ! video/x-raw, format=BGRx, width=1280, height=720 ! appsink drop=1"
# camera_url = "rtspsrc location=rtsp://admin:Dd22864549*@192.168.1.61:554 latency=0 ! rtph264depay ! h264parse ! omxh264dec ! appsink drop=1"


vid = cv2.VideoCapture(camera_url)


# if not cam.isOpened():nvvidconv ! video/x-raw, format=BGRx, width=1280, height=720
#         print("Error onvvidconv ! video/x-raw, format=BGRx, width=1280, height=720




# vid = cv2.VideoCapture("1.mp4")
img_out_name = f"/crop_"
